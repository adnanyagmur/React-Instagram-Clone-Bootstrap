...
> 
    <Navbar bg="light">
        ...
        <Navbar.Collapse className="justify-content-center m">
          <Form className="d-flex">
            <FormControl
              ...
              aria-label="Search"
            />  <Image className="mt-1 mx-1 " src={SearchLogo} alt="instagramLogoYazi" height="22px"></Image>
          </Form>
        </Navbar.Collapse>
        </Col>
        <Col sm={4}>
        <Navbar.Collapse className="justify-content-center">
          ...
          <Image className="mx-2 mb-2 " src={HeartsIcons} alt="compass icons" height="25px"></Image>
        </Navbar.Collapse>
        </Col>
      </Container>
