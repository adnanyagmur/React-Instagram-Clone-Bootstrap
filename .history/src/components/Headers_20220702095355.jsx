    ...
    <Navbar bg="light">
      <Container>
        ...
        <Navbar.Collapse className="justify-content-center">
          <Image className="mx-1 " src={HomeIcons} alt="HomeIcons" height="25px"></Image>
          <Image className="mx-1 " src={MesengerIcons} alt="mesenger İcons " height="25px"></Image>

          <Image className="mx-1 " src={CompassIcons} alt="compass icons" height="25px"></Image>
          <Image className="mx-1 mb-1 " src={HeartsIcons} alt="compass icons" height="25px"></Image>
        </Navbar.Collapse>
      </Container>
    </Navbar>
