    ...
    <Navbar bg="light">
      <Container>
        ...
        <Navbar.Collapse className="justify-content-center">
          <Image className="mx-3 " src={HomeIcons} alt="HomeIcons" height="25px"></Image>
          <Image className="mx-3 " src={MesengerIcons} alt="mesenger İcons " height="25px"></Image>

          <Image className="mx-3 " src={CompassIcons} alt="compass icons" height="25px"></Image>
          <Image className="mx-3 " src={HeartsIcons} alt="compass icons" height="25px"></Image>
        </Navbar.Collapse>
      </Container>
    </Navbar>
