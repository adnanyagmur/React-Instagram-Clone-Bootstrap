    ...
    <Navbar bg="light">
      <Container>
        ...
        <Navbar.Collapse className="justify-content-end">
          <Image className="mt-1 mx-2 " src={HomeIcons} alt="instagramLogoYazi" height="25px"></Image>
          <Image className="mt-1 mx-2 " src={MesengerIcons} alt="instagramLogoYazi" height="25px"></Image>

          <Image className="mt-1 mx-2 " src={CompassIcons} alt="instagramLogoYazi" height="25px"></Image>
