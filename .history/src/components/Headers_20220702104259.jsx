        ...
        <Navbar.Collapse className="justify-content-center m">
          <Form className="d-flex">
            <FormControl
              type="search"
              placeholder="Search"
              className="mb-1 me-2 d-none d-sm-block"
              aria-label="Search"
            />  <Image className="mb-1 mx-1 " src={SearchLogo} alt="instagramLogoYazi" height="22px"></Image>
          </Form>
        </Navbar.Collapse>
        </Col>
        <Col sm={4}>
        <Navbar.Collapse className="justify-content-center">
          <Image className="mx-2 mb-1 " src={HomeIcons} alt="HomeIcons" height="25px"></Image>
          <Image className="mx-2 mb-1 " src={MesengerIcons} alt="mesenger İcons " height="25px"></Image>

          <Image className="mx-2 mb-1 " src={CompassIcons} alt="compass icons" height="25px"></Image>
          <Image className="mx-2 mb-2 d-none d-sm-block" src={HeartsIcons} alt="compass icons" height="25px"></Image>
        </Navbar.Collapse>
        </Col>
      </Container>
