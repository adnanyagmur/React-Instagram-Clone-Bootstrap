...
const Headers = () => {
  ...
  return (
    ...
    <Navbar bg="light">
        ...
        <Col sm={4}>
        <Navbar.Collapse className="justify-content-center">
          <Image className="mr-3 mb-1 " src={HomeIcons} alt="HomeIcons" height="25px"></Image>
          <Image className="m3--2 mb-1 " src={MesengerIcons} alt="mesenger İcons " height="25px"></Image>
